...
def contains_advertisement(update: Update) -> bool:
    ...
    if update.message:
        ...
        ad_keywords = ["скидка", "купить", "реклама", "shop", "sale", "http", "https", "интересно", "прибыль", "пиши", "пишите", "ждем тебя", "ждём тебя",
                       "ищу", "людей", "доход", "работа", "работу", "человека", "удалёнка", "доллар", "долларов", "в лс", "нужно", "личку", "лич"]

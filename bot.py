...
def contains_advertisement(update: Update) -> bool:
    ...
    ad_keywords = [
        ...
        "Оставит", "Озорная", "Озорную", "Brandbook", "Target", "Казик", "Falsh", "Фальш", "обнаженных", "обнажённых",
        "обнаженные", "обнаженный", "обнажённые", "обнажённый", "каз", "Kaзино", "зaплaчy", "подpaбoтка","50", "эллик",
        "еллик", "доллар", "$" , "640 минг", "олти юз кирк", "олти юз қирқ", "Играю тут"
    ]
